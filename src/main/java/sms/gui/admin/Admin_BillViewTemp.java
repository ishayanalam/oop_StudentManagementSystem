...
public class Admin_BillViewTemp extends javax.swing.JFrame {
    
    private final int studentID;
    private double totalBill;  
    private double totalPaid;
    public Admin_BillViewTemp(int ID) {
        this.studentID = ID;
        initComponents();
    ...
    try (Connection connection = DatabaseConnection.getConnection();
        ...
        try (ResultSet resultSet = preparedStatement.executeQuery()) {
            ...
            if (!resultSet.isBeforeFirst()) { 
                ...
                JOptionPane.showMessageDialog(this, "Bill Information not found, Please check student ID");
                return; 
            }
            
            
            String[] columnNames = {"Date", "Title", "Amount"};
            DefaultTableModel showBills = new DefaultTableModel(columnNames, 0);
            while (resultSet.next()) {
                Date billDate = resultSet.getDate("billDate");
                String billTitle = resultSet.getString("billTitle");
                double amount = resultSet.getDouble("amount");
                showBills.addRow(new Object[]{billDate, billTitle, amount});
            }
            billTable.setModel(showBills); 
        }
    } catch (SQLException e) {
        
        JOptionPane.showMessageDialog(this, "Failed to load bill data");
    }
}
    ...
    private void calculateTotalPaid(int studentID)
    {
       ...
       try (Connection connection = DatabaseConnection.getConnection();
        ...
        JOptionPane.showMessageDialog(this, "Failed to load payment data");
    }
    ...
    private void initComponents() {
        ...
        amountTOPay.setText("No Data Found");
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(addBill, javax.swing.GroupLayout.DEFAULT_SIZE, 227, Short.MAX_VALUE)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addComponent(addBill, javax.swing.GroupLayout.PREFERRED_SIZE, 53, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void addBillActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBillActionPerformed
        ...
        Admin_BillAdd newAddBill = new Admin_BillAdd(studentID);
        newAddBill.setVisible(true);
    ...
    private void goDashboardActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_goDashboardActionPerformed
        ...
        this.dispose();
        Admin_Dashboard goDashboard = new Admin_Dashboard();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_BillViewTemp().setVisible(true);
            }
        });
    }
